...
var ConnexionTokenService = /** @class */ (function () {
    ...
    ConnexionTokenService.prototype.isConnected = function () {
        var conn = this.get();
        if (conn) {
    ...
    ConnexionTokenService.prototype.get = function () {
        return this.toolbox.readFromStorage(this.storageKey);
    };
    ConnexionTokenService.prototype.getToken = function () {
        var conn = this.get();
        if (conn) {
            return conn.token;
        }
    ...
    ConnexionTokenService.prototype.getUser = function () {
        var conn = this.get();
