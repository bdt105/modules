...
let r = new Rest();
PDVs.forEach(element => {
    let url = encodeURI("https://maps.googleapis.com/maps/api/geocode/json?address=Intermarché " + element.city + "&key=AIzaSyD4sEQaNWpU3KH-mVfCCxrPWWPYOJ4nDBQ");
