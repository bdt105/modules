export declare class Vidal {
    ...
    getProducts(callback: Function, params: string, filter: string, logParams?: any): void;
    ...
    getPrescriptionUnits(callback: Function, type: string, id: string, logParams?: any): void;
    getPrescriptionRoutes(callback: Function, type: string, id: string, params?: any): void;
    finishLogParams(param: any, data: any, error: any): void;
    initLogParams(params: any, url: string, body?: any, response?: any, raw?: any): any;
    getIndications(callback: Function, type: string, id: string, params?: any): void;
    getIndicators(callback: Function, type: string, id: string, params?: any): void;
    ...
    getProduct(callback: Function, type: string, id: number, logParams?: any): void;
